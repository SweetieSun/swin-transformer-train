...
def parse_option():
    ...
    parser.add_argument('--cfg', type=str, default='configs/swin/swin_tiny_patch4_window7_224.yaml', required=True, metavar="FILE", help='path to config file', )
    parser.add_argument(
        "--opts",
    ...
    parser.add_argument('--data-path', type=str, default='imagenet', help='path to dataset')
